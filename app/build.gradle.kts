...
licensee {
    ...
    // Jitsi SDK React Native dependencies licenses (Facebook/Meta)
    allowUrl("https://github.com/facebook/react-native/blob/main/LICENSE")
    allowUrl("https://github.com/facebook/react-native/blob/HEAD/LICENSE")
    ...
    allowUrl("https://github.com/facebook/infer/blob/main/LICENSE")
    allowUrl("https://github.com/facebook/soloader/blob/main/LICENSE")
    allowUrl("https://github.com/facebook/yoga/blob/master/LICENSE")
    allowUrl("https://github.com/facebook/yoga/blob/main/LICENSE")
