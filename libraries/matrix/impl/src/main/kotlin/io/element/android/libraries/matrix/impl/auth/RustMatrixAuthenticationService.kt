...
class RustMatrixAuthenticationService(
    ...
    override suspend fun login(username: String, password: String): Result<SessionId> =
        withContext(coroutineDispatchers.io) {
            runCatchingExceptions {
                ...
                client.login(username, password, "Chator", null)
    ...
    override suspend fun register(username: String, password: String, initialDeviceName: String): Result<SessionId> =
        withContext(coroutineDispatchers.io) {
            runCatchingExceptions {
                val client = currentClient ?: error("You need to call `setHomeserver()` first")
                ...
                Timber.e(failure, "Failed to register")
                failure.mapAuthenticationException()
            }
        }
