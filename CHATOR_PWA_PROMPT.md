...
## Target
- **Homeserver**: `https://chator.crabdance.com`
...
- Base URL: `https://chator.crabdance.com`
...
- `service-worker.js`: cache-first for static, network-only for `chator.crabdance.org/_matrix/*`
